...
// ===----------------------------------------------------------------------===//
//
// This source file is part of the swift-emailaddress open source project
//
// Copyright (c) 2026 Coen ten Thije Boonkkamp and the swift-emailaddress project authors
